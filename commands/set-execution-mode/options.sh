...
# Created: Sat Dec 19 11:36:44 PST 2015
#
#/ usage: rundeck-system:set-execution-mode [ --format <profile>]  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>]  --execution-mode <> 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --execution-mode) rerun_option_check $# $1; EXECUTION_MODE=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
    ...
    [[ -z "$EXECUTION_MODE" ]] && { echo >&2 "missing required option: --execution-mode" ; return 2 ; }
