...
# Created: Sat Dec 19 10:02:12 PST 2015
#
#/ usage: rundeck-system:info  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --format <profile>] [ --apikey <$RUNDECK_APIKEY>] 
