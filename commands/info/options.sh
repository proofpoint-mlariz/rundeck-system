...
# Created: Tue Feb 16 15:59:39 PST 2016
#
#/ usage: rundeck-system:info [ --format <profile>]  --url <${RUNDECK_URL:-}> [ --username <${RUNDECK_USER:-}>] [ --password <${RUNDECK_PASSWORD:-}>] [ --apikey <${RUNDECK_APIKEY:-}>] [ --file <>] 
