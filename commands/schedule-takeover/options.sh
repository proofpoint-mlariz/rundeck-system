...
# Created: Thu Feb 18 15:42:09 PST 2016
#
#/ usage: rundeck-system:schedule-takeover  --uuid <all> [ --project <>] [ --timestamp-threshold <>] [ --timestamp <>]  --url <${RUNDECK_URL:-}> [ --username <${RUNDECK_USER:-}>] [ --password <${RUNDECK_PASSWORD:-}>] [ --apikey <${RUNDECK_APIKEY:-}>] [ --exclude-project <>] 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --exclude-project) rerun_option_check $# $1; EXCLUDE_PROJECT=$2 ; shift ;;
            # help option
